...
interface PatientCompanionFormProps {
    onClose: () => void;
...
export function PatientCompanionForm({ onClose, onSave, onChange, onNavigateToPatient, initialData, userRole }: PatientCompanionFormProps) {
    console.log('User Role in PatientCompanionForm:', userRole); // Use userRole to fix lint
    ...
    useEffect(() => {
        if (initialData) {
            ...
            if (initialData.companionType || initialData.type) {
                setCompanionType(initialData.companionType || initialData.type);
            }
                    ...
                    <section
                        ...
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">
                                        Active patient information for this companion
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            {patients.map((patient, index) => (
                                <div key={index} className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm transition-all duration-200">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="md:col-span-2">
                                            ...
                                            <input
                                                ...
                                                value={patient.name}
                                                readOnly
                                                className="w-full px-4 py-2.5 border border-gray-200 rounded-lg bg-gray-50 text-gray-500 text-sm cursor-not-allowed focus:outline-none transition-all"
                                            />
                                        </div>
                                        <div>
                                            <label className="block text-sm font-semibold text-gray-700 mb-2">
                                    ...
                                    <div className="mt-8 pt-6 border-t border-gray-100">
                                        <div className="flex items-center justify-between mb-6 bg-blue-50/50 p-4 rounded-xl border border-blue-100/50">
                                            <div className="flex items-center gap-3">
                                                <div className="h-8 w-8 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center transition-colors">
                                                    <Calendar size={18} />
                                                </div>
                                                <div>
                                                    <h4 className="text-sm font-semibold text-gray-900">Appointment Details</h4>
                                                    <p className="text-[10px] text-gray-500 uppercase font-bold tracking-wider">Viewing scheduled slot</p>
                                                </div>
                                            </div>
                                            ...
                                            <Button
                                                variant="outline"
                                                size="sm"
                                                className="gap-2 bg-white border-blue-200 text-blue-600 hover:bg-blue-50 font-bold"
                                                onClick={() => {
                                                    const pId = patient.id || (initialData as any).patientId;
                                                    if (onNavigateToPatient && pId) {
                                                        onNavigateToPatient(pId);
                                                    } else {
                                                        // Fallback navigation if ID is missing (should not happen if data is right)
                                                        onNavigateToPatient?.('PAT-0001');
                                                    }
                                                }}>
                                                <Calendar size={14} />
                                        ...
                                        {patient.appointment && (
                                            <div className="space-y-4 mt-4 p-4 bg-gray-50/10 rounded-xl border border-gray-100 animate-in fade-in slide-in-from-top-2 duration-200">
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    <div className="md:col-span-2">
                                                        ...
                                                        <input
                                                            ...
                                                            readOnly
                                                            className="w-full px-3 py-2 border border-gray-100 rounded-lg bg-gray-50/50 text-gray-500 text-sm focus:outline-none transition-all"
                                                        />
                                                    </div>
                                                    <div>
                                                        <label className="block text-xs font-bold text-gray-400 mb-1.5 uppercase tracking-wider">
                                                    ...
                                                    <div className="md:col-span-2">
                                                        ...
                                                        <textarea
                                                            ...
                                                            readOnly
                                                            rows={2}
                                                            className="w-full px-3 py-2 border border-gray-100 rounded-lg bg-gray-50/50 text-gray-500 text-sm focus:outline-none resize-none transition-all"
                                                        />
                                                    </div>
                                                </div>
                                            </div>
